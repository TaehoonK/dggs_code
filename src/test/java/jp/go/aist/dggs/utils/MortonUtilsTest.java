...
public class MortonUtilsTest {
    ...
    @Test
    public void convertToMorton() throws Exception {
    ...
    public void convertToMorton_TriangleCheck() throws Exception {
    ...
    public void convertMortonToLatLong3D() throws Exception {
